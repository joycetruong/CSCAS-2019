...
(function(){
    ...
    (function() {
    var p = "4002347", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_4002347||'',
    guid:window.ftGUID_4002347||'',
    confID:window.ftConfID_4002347||'0',
    ftReturn: window.ftReturn_4002347||'',
    keyword:window.ftKeyword_4002347||'',
    ftId:window.ftId_4002347||'',
    ftImpId:window.ftImp4002347 && window.ftImp4002347.impID || '',
    campaignID: '113031',
    cID:'100888',
    pID:'4002347',
    creativeID:'2793892',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=113031&sid=240&plc=4002347&num=&adid=&advid=&adsrv=29&btreg=4002347&btadsrv=flashtalking&crt=2793892&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/113031;4002347;2793892;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://stock.adobe.com/ca/collections/T0H6LqZIehS9WQb8SAoL5vu1dSKF9IbT?sdid=G85SYRPF&mv=display&as_channel=display&as_campclass=nonbrand&as_camptype=discovery&as_source=google&as_campaign=stockdisplay'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?149641774-4002347;2793892;',
    centreAd: true,
    width:728,
    height:90,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/400/4002347/2793892/image/2793892.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/113031;4002347;202;pixel;Google;GoogleFY19StockDiscoverCTXCTXCANPAWB728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/113031;4002347;2793892;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://stock.adobe.com/ca/collections/T0H6LqZIehS9WQb8SAoL5vu1dSKF9IbT?sdid=G85SYRPF&mv=display&as_channel=display&as_campclass=nonbrand&as_camptype=discovery&as_source=google&as_campaign=stockdisplay',
    divID:'ftdiv4002347',
    altimgID:'ftalt4002347',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4002347 && parseInt(window.ftImp4002347.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4002347') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m4002347'),
    pageVisible: 'maybe',
